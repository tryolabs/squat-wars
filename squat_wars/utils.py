...
from squat_wars.data import Person

# parametrizing these colours should be great.
RIGHT_SIDE_COLOR = (64, 86, 244)  # (44, 221, 179)
LEFT_SIDE_COLOR = (64, 86, 244)  # (44, 221, 179)
MIDDLE_COLOR = (229, 234, 239)

# map edges to a RGB color
KEYPOINT_EDGE_INDS_TO_COLOR = {
    (0, 1): LEFT_SIDE_COLOR,
    (0, 2): RIGHT_SIDE_COLOR,
    (1, 3): LEFT_SIDE_COLOR,
    (2, 4): RIGHT_SIDE_COLOR,
    (0, 5): LEFT_SIDE_COLOR,
    (0, 6): RIGHT_SIDE_COLOR,
    (5, 7): LEFT_SIDE_COLOR,
    (7, 9): LEFT_SIDE_COLOR,
    (6, 8): RIGHT_SIDE_COLOR,
    (8, 10): RIGHT_SIDE_COLOR,
    (5, 6): MIDDLE_COLOR,
    (5, 11): LEFT_SIDE_COLOR,
    (6, 12): RIGHT_SIDE_COLOR,
    (11, 12): MIDDLE_COLOR,
    (11, 13): LEFT_SIDE_COLOR,
    (13, 15): LEFT_SIDE_COLOR,
    (12, 14): RIGHT_SIDE_COLOR,
    (14, 16): RIGHT_SIDE_COLOR,
}
        ...
        for edge_pair, edge_color in KEYPOINT_EDGE_INDS_TO_COLOR.items():
            if (
                ...
                cv2.line(
                    ...
                    edge_color[::-1],  # erase [::-1] if colours are displayed backwards
                    2,
                )
